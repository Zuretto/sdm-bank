...
class MakePaymentTest {
    ...
    void shouldTransferMoneyInterBank() {
        ...
        final var account1 = new ClassicAccount(Mockito.mock(Person.class), bank1.getNextId(), Mockito.mock(InterestMechanism.class));
        final var account2 = new ClassicAccount(Mockito.mock(Person.class), bank2.getNextId(), Mockito.mock(InterestMechanism.class));
    ...
    void shouldTransferMoneyInnerBank() {
        final var bank1 = new Bank("0001");
        final var account1 = new ClassicAccount(Mockito.mock(Person.class), bank1.getNextId(), Mockito.mock(InterestMechanism.class));
        final var account2 = new ClassicAccount(Mockito.mock(Person.class), bank1.getNextId(), Mockito.mock(InterestMechanism.class));
        account1.setBalance(new BigDecimal("100"));
        bank1.addAccount(account1);
